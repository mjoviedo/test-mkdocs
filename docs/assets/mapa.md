...
### Capítulo 1.1 Nivelación 

#### Bases de la computación

- Genealogía de la computadora
Calculadoras humanas y mecánicas
¿Cómo llegamos a la computadora moderna?

#### Teoría matemática de la información

- Teoría matemática de la información (Shannon)
Magnitudes de la información (bits, bytes)

#### Estructura básica del hardware

- Arquitectura de Von Neumann
Cómo funciona la computadora moderna
...
- Servidores, protocolos, paquetes, DNS, navegadores, páginas
...
- Definición, características, usos, tipos, formatos y softwares

### Capítulo 1.2. Introducción a la IA
...
- Historia, concepto, cómo funcionan

#### Redes neuronales

- Funcionamiento, capas
...
### Capítulo 1.3. Procesamiento de lenguaje natural
...
### Capítulo 1.4. Nociones básicas de infraestructura para IA
