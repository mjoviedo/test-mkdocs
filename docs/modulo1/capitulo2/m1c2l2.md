...
Consideremos, por ejemplo, determinar la edad de una persona a partir de su fotografía. De alguna manera, aprendemos a hacerlo, porque hemos visto muchos ejemplos de personas de diferentes edades, pero no podemos explicar taxativamente cómo lo hacemos ni programar la computadora para que lo haga. Este es precisamente el tipo de tarea que interesa a la Inteligencia Artificial (IA).


## La definición de inteligencia y la prueba de Turing

Uno de los problemas al tratar con el término **[Inteligencia](https://es.wikipedia.org/wiki/Inteligencia)** es que no hay una definición clara de este término. Se puede argumentar que la inteligencia está conectada con el **pensamiento abstracto** o con la **autoconciencia**, pero no podemos definirlo adecuadamente.

![Una persona está sentada en un sillón escribiendo en un cuaderno, con bocadillos de diálogo que muestran trazos indefinidos y, a continuación, una bombilla. Cerca, una mesa con un ordenador portátil que muestra la interfaz de un chatbot de LLM y una taza.](/assets/modulo1/distant-writing.png)

> Foto por [Fabrizio Matarese](https://betterimagesofai.org/images?artist=FabrizioMatarese&title=DistantWriting)
