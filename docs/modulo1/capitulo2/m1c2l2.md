...
![Foto de una persona con barba candado señalada con un un recuadro blanco y un rótulo con un dibujo de persona y el número 37](../img/edad.png)
...
![Una persona está sentada en un sillón escribiendo en un cuaderno, con bocadillos de diálogo que muestran trazos indefinidos y, a continuación, una bombilla. Cerca, una mesa con un ordenador portátil que muestra la interfaz de un chatbot de LLM y una taza.](../img/distant-writing.png)
