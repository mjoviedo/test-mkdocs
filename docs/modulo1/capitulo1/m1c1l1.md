...
!!! info "Introducción"
    ...
    Este curso parte de una premisa: 
    para pensar y utilizar IA en Educación Superior necesitamos entender sus fundamentos a nivel técnico. Y, para lograr esto, necesitamos asegurarnos de comprender las bases de la computación tradicional, de internet y lo que hoy llamamos plataformas. Comencemos entonces con la computadora.
...
![La Pascalina, una máquina antigua de calcular](/assets/modulo1/pascalina.jpeg)

Una de las primeras máquinas de este tipo fue La Pascalina, diseñada por el filósofo Blas Pascal en 1642. La Pascalina era una máquina compuesta de engranajes que permitían realizar sumas y restas . Dado que algunas ruedas dentadas operaban como unidades, otras como decenas y otras como centenas, se obtenían distintas cifras según su posición. Pocos años después el alemán Gottfried Leibniz, otro filósofo y matemático, sumó a este sistema un elemento revolucionario: un cilindro metálico de dientes irregulares, conocido como "la rueda de Leibniz", y que siguió utilizándose en máquinas de calcular hasta entrado el siglo XX.

## Máquinas programables

Pero una calculadora, en sentido estricto, no es un buen antecedente, ya que una computadora es esencialmente una máquina programable para realizar distintos tipos de operaciones.

La primera máquina programable fue un telar diseñado por Joseph-Marie Jacquard el hijo de un hilandero que en pleno siglo XVIII inventó un telar automático. En el telar de Jacquard se podían introducir unas tablitas de cartón con agujeros cuyo orden establecía el patrón con el que subían y bajaban las agujas.

![Un telar de madera antiguo](/assets/modulo1/telar.jpg)
...
![Foto en blanco y negro de un grupo de mujeres en una oficina realizando cuentas en hojas de papel](/assets/modulo1/computadoras-humanas.jpg)
...
![La computadora ENIAC, antigua y del tamaño de un ropero detrás de una vitrina en un museo](/assets/modulo1/ENIAC.jpg)
